...
static BASELINE_PARAMS: std::sync::LazyLock<HeuristicParams> = std::sync::LazyLock::new(|| {
    const JSON: &str = include_str!("../../../genetic-algorithm/batch-lki08w-gen-14.json");
...
const PARAM_GROUPS: &[(&str, &[&str])] = &[
    ...
    ("Material Weights", &[
        "stored_ceramics_weight", "stored_paintings_weight", "stored_textiles_weight",
        "deck_thinning_value", "chalk_quality", "starter_material_quality",
        "ceramics_material_quality", "paintings_material_quality", "textiles_material_quality",
        "dual_material_quality",
    ]),
    ("Card Type Quality", &[
        "basic_dye_quality",
    ]),
...
fn get_param_value(params: &HeuristicParams, name: &str) -> Option<f64> {
    match name {
        ...
        "stored_ceramics_weight" => Some(params.stored_ceramics_weight),
        "stored_paintings_weight" => Some(params.stored_paintings_weight),
        "stored_textiles_weight" => Some(params.stored_textiles_weight),
        "deck_thinning_value" => Some(params.deck_thinning_value),
        ...
        "ceramics_material_quality" => Some(params.ceramics_material_quality),
        "paintings_material_quality" => Some(params.paintings_material_quality),
        "textiles_material_quality" => Some(params.textiles_material_quality),
