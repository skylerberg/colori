...
| Action | Description |
|--------|-------------|
| **Sell** | Triggers the selling process |
| **Store Colors ×N** | Store N color points for later use |
| **Mix Colors ×N** | Combine N color points into new colors |
| **Draw Cards ×N** | Draw N cards from the deck |
| **Destroy Cards ×N** | Force destruction of N cards (yours or opponent's) |
...
| 🟢 | Green | Secondary |
| 🟣 | Purple | Secondary |
| 🟠 | Vermilion | Tertiary (Red-Orange) |
| 🟡 | Amber | Tertiary (Yellow-Orange) |
| 🟢 | Chartreuse | Tertiary (Yellow-Green) |
| 🩵 | Teal | Tertiary (Blue-Green) |
| 💙 | Indigo | Tertiary (Blue-Purple) |
| 💜 | Magenta | Tertiary (Red-Purple) |
...
*Each player begins with 8 copies of each starter card (24 total).*
...
- **Colors:** 🔴 Red ×2, 💜 Magenta ×1
- **Destroy Action:** Draw Cards ×2
...
- **Colors:** 🔴 Red ×2, 🟠 Vermilion ×1
- **Destroy Action:** Store Colors ×2

### 4. Brazilwood

- **Art Description:** A merchant's workshop table with curls of reddish heartwood shavings piled around a hand plane. A steaming pot behind them shows the wood chips simmering into a rose-red liquor.
- **Colors:** 🔴 Red ×2
- **Destroy Action:** Draw Cards ×1

### 5. Lac

- **Art Description:** Dark resinous crusts scraped from the twigs of a tropical tree, piled on a brass scale. The resin gleams with a deep ruby sheen in candlelight. Silk thread hangs drying in the background, stained a rich crimson.
- **Colors:** 🔴 Red ×2, 💜 Magenta ×1
- **Destroy Action:** Mix Colors ×1

### 6. Safflower

- **Art Description:** A field of bright orange-red thistle-like flowers being gathered into linen bundles by a young worker. Petals float in a shallow stone basin of water, bleeding clouds of pink and red into the clear liquid.
- **Colors:** 🔴 Red ×1, 💜 Magenta ×1
- **Destroy Action:** Draw Cards ×1

### 7. Alkanet

- **Art Description:** A tangle of dark roots with rough bark, soaking in a jar of clear spirit that has turned a vivid reddish-violet. The glass jar catches the light from a workshop window, casting purple shadows across the table.
- **Colors:** 🔴 Red ×1, 🟣 Purple ×1
- **Destroy Action:** Mix Colors ×1

### 8. Dragon's Blood

- **Art Description:** A cracked sphere of dark resin, deep red like a blood clot, sitting atop a bed of dried palm leaves. A mortar and pestle nearby shows the resin ground to a fine scarlet powder. Exotic carvings on the wooden shipping crate hint at its Far Eastern origin.
- **Colors:** 🔴 Red ×2, 🟠 Vermilion ×1
- **Destroy Action:** Destroy Cards ×1

### 9. Venetian Red Earth

- **Art Description:** A chunk of rusty hematite ore being ground on a stone slab, the powder a warm brownish-red. Behind it, the distinctive red-brick buildings of Venice rise from green canal water, their color a testament to this very earth.
- **Colors:** 🔴 Red ×1, 🟠 Vermilion ×1, 🟡 Amber ×1
- **Destroy Action:** Store Colors ×1
...
- **Colors:** 🔴 Red ×1, 🟠 Vermilion ×2
- **Destroy Action:** Destroy Cards ×2
...
- **Colors:** 🔵 Blue ×2, 💙 Indigo ×1
- **Destroy Action:** Sell

### 13. Smalt

- **Art Description:** Cobalt-blue glass being smashed with a hammer on an iron anvil, the fragments scattered like dark sapphires. A Murano glassblower's furnace glows in the background. A fine blue powder is being swept into a ceramic jar with a soft brush.
- **Colors:** 🔵 Blue ×2, 💙 Indigo ×1
- **Destroy Action:** Destroy Cards ×1
...
- **Colors:** 🔵 Blue ×1, 💙 Indigo ×1, 🟣 Purple ×1
- **Destroy Action:** Mix Colors ×2
...
- **Colors:** 🟡 Yellow ×2, 🟡 Amber ×1
- **Destroy Action:** Draw Cards ×3
...
- **Colors:** 🟡 Yellow ×1, 🟡 Amber ×1, 🟠 Orange ×1
- **Destroy Action:** Mix Colors ×1
...
- **Art Description:** Tall whip-like stems topped with fragrant golden flowers, bundled with twine on a cart. The Mediterranean sun beats down on a hillside covered in the bright yellow shrubs, the sea visible in the distance.
- **Colors:** 🟡 Yellow ×2
- **Destroy Action:** Store Colors ×1

### 21. Old Fustic

- **Art Description:** Thick slabs of golden-brown heartwood stacked in a warehouse, their cut surfaces showing a rich honey-yellow. Wood shavings curl into a steaming vat, turning the water a deep warm yellow. Sawdust on the floor is stained amber.
- **Colors:** 🟡 Yellow ×2, 🟡 Amber ×1
- **Destroy Action:** Store Colors ×2

### 22. Young Fustic / Venetian Sumac

- **Art Description:** Feathery rounded leaves of a small tree, turning orange-red in autumn. Branches are being stripped of bark and leaves into a stone basin. The hills of the Veneto countryside roll behind, dotted with these distinctive smoke-tree shrubs.
- **Colors:** 🟡 Yellow ×1, 🟡 Amber ×1, 🟠 Orange ×1
- **Destroy Action:** Mix Colors ×1
...
- **Art Description:** A rocky Mediterranean shore strewn with thousands of broken murex snail shells, their insides stained violet. A stone vat filled with a foul, blackish liquor sits in the sun. A single strip of cloth draped over the vat's edge has turned a magnificent reddish-purple.
- **Colors:** 🟣 Purple ×2, 💜 Magenta ×1
- **Destroy Action:** Sell
...
- **Colors:** 🟣 Purple ×1, 💜 Magenta ×1, 🔴 Red ×1
- **Destroy Action:** Mix Colors ×2

### 26. Turnsole

- **Art Description:** Small silver-green plants with tiny flowers being pressed between linen cloths. The cloth absorbs a violet juice that deepens as it dries. Stacked sheets of turnsole-stained cloth sit ready to be shipped to dyers and manuscript illuminators alike.
- **Colors:** 🟣 Purple ×2
- **Destroy Action:** Store Colors ×1

### 27. Elderberry

- **Art Description:** Heavy clusters of dark purple-black berries hanging from arching branches over a garden wall. A large wooden bowl overflows with harvested berries, some crushed and bleeding juice that stains the table a dusky violet.
- **Colors:** 🟣 Purple ×1, 💙 Indigo ×1
- **Destroy Action:** Draw Cards ×2
...
- **Colors:** 🟢 Green ×2, 🩵 Teal ×1
- **Destroy Action:** Destroy Cards ×1

### 29. Lincoln Green

- **Art Description:** A split scene: on the left, cloth emerges from a blue woad vat; on the right, the same cloth is lowered into a golden weld bath. In the center, the finished fabric hangs drying — a rich deep green like forest shadow. An archer's hood hangs nearby.
- **Colors:** 🟢 Green ×1, 🩵 Teal ×1, 🔵 Blue ×1
- **Destroy Action:** Mix Colors ×3

### 30. Saxon Green

- **Art Description:** A master dyer holds up a length of bright emerald cloth to the workshop window, inspecting the color against daylight. Behind him, two vats sit side by side — one dark with indigo, one golden with fustic — the secret of his vibrant green.
- **Colors:** 🟢 Green ×2, 🟢 Chartreuse ×1
- **Destroy Action:** Store Colors ×3
...
- **Art Description:** Hard round growths clustered on an oak twig, some cracked open to reveal a dense tannin-rich interior. A stone bowl of crushed gall nuts sits in murky brown water. Iron nails rest on the workbench nearby — the key to turning this brown into black.
- **Colors:** 🟡 Yellow ×1, 🟡 Amber ×1
- **Destroy Action:** Destroy Cards ×1

### 32. Walnut Hulls

- **Art Description:** Green walnut husks split open, their interiors already blackening and staining fingers dark brown. A pile of dried husks soaks in a stone trough, the water turned a rich umber. A dyer wrings out a length of linen, now a warm chocolate brown.
- **Colors:** 🟠 Vermilion ×1, 🟡 Amber ×1, 🟠 Orange ×1
- **Destroy Action:** Draw Cards ×1

### 33. Oak Bark

- **Art Description:** Rough bark stripped from a felled oak, stacked in a tanner's yard. Steam rises from a long wooden vat where the bark steeps, turning the water a reddish-tan. Leather hides hang drying alongside dyed wool — both products of the same bark.
- **Colors:** 🟡 Yellow ×1, 🟡 Amber ×1
- **Destroy Action:** Store Colors ×1

### 34. Cutch / Catechu

- **Art Description:** Dark crystalline chunks of concentrated tree extract, imported in small wooden boxes stamped with East Indian trading marks. When dissolved in hot water, it produces a warm reddish-brown. A silk merchant tests a swatch, pleased with the rich cinnamon tone.
- **Colors:** 🔴 Red ×1, 🟡 Amber ×1, 🟠 Orange ×1
- **Destroy Action:** Mix Colors ×1

### 35. Chestnut

- **Art Description:** Split chestnut husks with their spiny green shells and dark brown nuts scattered on a workshop floor. A cauldron steams with boiling husks and bark, the liquor a warm golden-brown. Autumn leaves drift past the open workshop door.
- **Colors:** 🟡 Amber ×1, 🟠 Orange ×1
- **Destroy Action:** Draw Cards ×1

### 36. Alder Bark

- **Art Description:** Wet strips of dark reddish bark peeled from a riverside tree, the inner bark still glistening. The tree stands at the edge of a Venetian lagoon island, its roots in the marshy water. A dye pot nearby produces a warm red-brown tone.
- **Colors:** 🔴 Red ×1, 🟡 Amber ×1
- **Destroy Action:** Store Colors ×1
...
- **Art Description:** A dramatic scene of a dyer's workshop at the final stage: a length of cloth, already blue from woad and red from madder, is plunged into a dark vat of iron-mordanted gall nut liquor. The cloth emerges jet black, steaming. The dyer's arms are stained to the elbow.
- **Colors:** 🔵 Blue ×1, 🟣 Purple ×1, 💙 Indigo ×1
- **Destroy Action:** Destroy Cards ×2
...
- **Art Description:** Bright red spiky seed pods cracked open to reveal clusters of small seeds coated in vivid orange-red paste. A New World trader presents them to a Venetian merchant, who rubs a seed between his fingers, staining them a brilliant sunset orange.
- **Colors:** 🟠 Orange ×1, 🟡 Amber ×1, 🟡 Yellow ×1
- **Destroy Action:** Mix Colors ×1

### 39. Henna

- **Art Description:** Dried olive-green leaves ground to a fine powder in a brass mortar, the powder a muted green that belies the warm orange it will produce. A woman's hands are stained with intricate orange-brown patterns. Linen cloth dyed a warm terra cotta hangs behind.
- **Colors:** 🟠 Orange ×1, 🟠 Vermilion ×1
- **Destroy Action:** Store Colors ×1
...
*Fabric cards provide no colors. They are required components for selling to buyers. Each fabric type corresponds to the fabric icon shown on buyer cards.*

### 🐑 Wool

- **Art Description:** A thick roll of raw undyed wool cloth, creamy white with a slightly rough texture. Sheep shears and a spindle rest on a wooden table beside it. The fabric has a visible weave and warm, sturdy weight to it.
- **Destroy Action:** Draw Cards ×1

### 🪱 Silk

- **Art Description:** A shimmering bolt of white silk unrolled across a merchant's table, catching the light with a luminous sheen. A lacquered box from the East sits open nearby, silkworm cocoons visible inside. The fabric seems to glow.
- **Destroy Action:** Draw Cards ×2

### 🌾 Linen

- **Art Description:** Pale, tightly woven linen cloth folded in crisp layers, with dried flax stalks bundled beside it. The fabric has a smooth, cool appearance with a subtle natural texture. A hackle comb for processing flax sits nearby.
- **Destroy Action:** Store Colors ×1

### 🌿 Cotton

- **Art Description:** Soft white cotton cloth draped over a basket, fluffy raw cotton bolls spilling out beside it. The fabric is lighter and more pliable than linen, with a matte finish. A cotton card with wire teeth lies on the workbench.
- **Destroy Action:** Mix Colors ×1
...
### 1. Kermes Crimson Robe

- **Associated Dye:** Kermes
- **Fabric:** 🪱 Silk
- **Cost:** 🔴 Red ×6 + 🪱 Silk
...
- **Associated Dye:** Venetian Red Earth
- **Fabric:** 🌾 Linen
...
- **Associated Dye:** Vermilion (Mineral)
- **Fabric:** 🪱 Silk
...
- **Associated Dye:** Young Fustic / Venetian Sumac
- **Fabric:** 🌾 Linen
...
- **Associated Dye:** Persian Berries
- **Fabric:** 🪱 Silk
...
### 24. Tyrian Purple Imperial Toga

- **Associated Dye:** Tyrian Purple
- **Fabric:** 🪱 Silk
...
### 28. Verdigris Copper-Green Surcoat

- **Associated Dye:** Verdigris
- **Fabric:** 🌾 Linen
...
### 31. Gall Nut Tan Breeches

- **Associated Dye:** Gall Nuts
- **Fabric:** 🌾 Linen
...
### 37. Iron Black Magistrate's Mantle

- **Associated Dye:** Iron Black
- **Fabric:** 🐑 Wool
...
### 38. Annatto Sunset Bandana

- **Associated Dye:** Annatto
- **Fabric:** 🌿 Cotton
...
|----------|-------|-------|
| Starter Cards | 3 types × 8 copies = 24 | Basic Red, Basic Yellow, Basic Blue |
| Dye Cards | 39 unique | Various copy counts TBD |
| Fabric Cards | 4 types | 🐑 Wool, 🪱 Silk, 🌾 Linen, 🌿 Cotton |
| Buyer Cards | 39 unique | One per dye, scoring cards |
| **Total unique cards** | **85** | |

## Fabric Distribution Across Buyers

| Fabric | Buyers Using It | Count |
|--------|-------------------|-------|
| 🐑 Wool | Madder, Brazilwood, Dragon's Blood, Indigo, Azurite, Logwood, Dyer's Broom, Spanish Broom, Old Fustic, Orchil, Turnsole, Elderberry, Lincoln Green, Walnut Hulls, Catechu, Iron Black | 16 |
| 🪱 Silk | Kermes, Cochineal, Lac, Safflower, Vermilion, Smalt, Saffron, Persian Berries, Tyrian Purple, Saxon Green | 10 |
...
| ★★★ | 10 | Madder Doublet, Dragon's Blood Cape, Azurite Mantle, etc. |
| ★★★★ | 9 | Cochineal Gown, Lac Sash, Vermilion Stole, Indigo Coat, etc. |
| ★★★★★ | 5 | Kermes Robe, Weld Dress, Tyrian Toga, Saxon Gown, Iron Black Mantle |
