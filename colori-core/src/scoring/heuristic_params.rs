...
pub struct HeuristicParams {
    ...
    pub rollout_sell_affordable_multiplier: f64,
    pub rollout_sell_base: f64,
    pub rollout_mix_base: f64,
    pub rollout_mix_pair_weight: f64,
    pub rollout_mix_count_weight: f64,
    pub rollout_mix_no_pairs: f64,
    pub rollout_workshop_base: f64,
    pub rollout_workshop_count_weight: f64,
    pub rollout_workshop_empty: f64,
    pub rollout_destroy_with_targets: f64,
    pub rollout_destroy_no_targets: f64,
    pub rollout_draw_base: f64,
    pub rollout_draw_count_weight: f64,
    pub rollout_other_priority: f64,
    pub rollout_end_turn_threshold: f64,
    pub rollout_end_turn_probability: f64,
    pub rollout_ws_material_base_multiplier: f64,
    pub rollout_ws_material_colors_met_multiplier: f64,
    pub rollout_ws_action_bonus: f64,
}
...
impl Default for HeuristicParams {
    ...
    fn default() -> Self {
        HeuristicParams {
            ...
            rollout_epsilon: 0.2,
            rollout_sell_affordable_multiplier: 25.0,
            rollout_sell_base: 35.0,
            rollout_mix_base: 50.0,
            rollout_mix_pair_weight: 3.0,
            rollout_mix_count_weight: 5.0,
            rollout_mix_no_pairs: 20.0,
            rollout_workshop_base: 60.0,
            rollout_workshop_count_weight: 7.0,
            rollout_workshop_empty: 15.0,
            rollout_destroy_with_targets: 45.0,
            rollout_destroy_no_targets: 25.0,
            rollout_draw_base: 30.0,
            rollout_draw_count_weight: 2.0,
            rollout_other_priority: 10.0,
            rollout_end_turn_threshold: 30.0,
            rollout_end_turn_probability: 0.5,
            rollout_ws_material_base_multiplier: 3.0,
            rollout_ws_material_colors_met_multiplier: 3.0,
            rollout_ws_action_bonus: 5.0,
        }
    }
}
