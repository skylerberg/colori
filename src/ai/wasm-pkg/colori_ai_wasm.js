/* @ts-self-types="./colori_ai_wasm.d.ts" */

/**
 * @param {string} game_state_json
 * @param {number} player_index
 * @param {number} iterations
 * @param {string} seen_hands_json
 * @returns {string}
 */
export function run_ismcts(game_state_json, player_index, iterations, seen_hands_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(game_state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(seen_hands_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.run_ismcts(ptr0, len0, player_index, iterations, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('colori_ai_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
